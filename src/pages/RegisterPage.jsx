...
import { Mail, Lock, User, Building2, MapPin, UserPlus } from 'lucide-react';
        ...
        <Card elevated className="p-8">
          ...
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-accent text-white mb-4"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Input
              ...
              placeholder="••••••••"
              helperText="Min 6 chars with uppercase, lowercase & number"
              required
            />
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-neutral-200 dark:border-ground-700" />
            </div>
